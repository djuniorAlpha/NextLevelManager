...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-full border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 hover:-translate-y-0.5 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 disabled:hover:translate-y-0 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-br from-accent-2 to-accent-4 text-white shadow-[0_10px_26px_-8px_rgba(120,0,248,0.45)] hover:shadow-[0_12px_32px_-8px_rgba(0,173,255,0.5)]",
        outline:
          "border-border bg-background hover:border-accent-4 hover:text-accent-4 aria-expanded:border-accent-4 aria-expanded:text-accent-4 dark:border-input dark:bg-input/30 dark:hover:bg-input/50",
        secondary:
